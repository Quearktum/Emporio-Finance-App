...
const configs = [
  ...
  },
  {
    ...
    render: (company: CompanyIncomeStatement) => formatRatio(company.grossProfit),
  },
  {
    label: "Opearting Income Ratio",
    render: (company: CompanyIncomeStatement) => formatRatio(company.operatingIncome),
  },
  {
    label: "Income Before Taxes Ratio",
    render: (company: CompanyIncomeStatement) => formatRatio(company.incomeBeforeTax),
  },
];
